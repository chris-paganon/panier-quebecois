...
<div class="woocommerce-billing-fields">
  ...
  <!--- Adds shipping table below billing section --->
...
<div class="woocommerce-account-fields">
  ...
  <p class="form-row form-row-wide create-account">
    <label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
      ...
      <span>
      <?php esc_html_e( 'Create an account to earn cash back after 5 orders', 'woocommerce' ); ?>
      </span>
    </label>
  </p>
  <?php endif; ?>
  ...
  <div class="create-account"> 
    <!--- Adds text above create account fields ---> 
    <?php echo '<div class="my_checkout_registration_form_div"><h5 class="my_checkout_registration_form_text"> Créez un compte ci-dessous ou connectez vous </h5> <a href="#my-checkout-login-id">ici</a></div>'; ?>
