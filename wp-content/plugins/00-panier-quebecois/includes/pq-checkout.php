...
function custom_woocommerce_empty_cart_button() {
	echo '<a id="btn_empty_cart" data-msg="' .  esc_attr(__('Etes vous sur de vouloir vider votre panier ?', 'panierquebecois' )) . '" href="' . esc_url( add_query_arg( 'empty_cart', 'yes' ) ) . '" class="button" title="' . esc_attr(__( 'Vider le panier', 'panierquebecois' )) . '">' . esc_html(__( 'Vider le panier', 'panierquebecois' )) . '</a>';
}
