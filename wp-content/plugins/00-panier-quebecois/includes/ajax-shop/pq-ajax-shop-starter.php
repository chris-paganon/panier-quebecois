    ...
    <div class="elementor-widget-container">
      <nav migration_allowed="1" migrated="0" role="navigation" class="elementor-nav-menu--main elementor-nav-menu__container elementor-nav-menu--layout-vertical e--pointer-text e--animation-none">
        <ul class="elementor-nav-menu sm-vertical">
          ...
          <li data-sequence="1" class="lesProducts menu-item menu-item-type-custom menu-item-object-custom current-menu-item"> <a href="<?php echo $url;?>#selection" aria-current="page" class="elementor-item elementor-item-anchor menu-link" producttarget="selectionTargetSidebar"><?php _e( 'Aubaines de la semaine' );?></a> </li>
      ...
      <nav migration_allowed="1" migrated="0" role="navigation" class="elementor-nav-menu--main elementor-nav-menu__container elementor-nav-menu--layout-vertical e--pointer-text e--animation-none">
        <ul class="elementor-nav-menu sm-vertical">
          ...
          <li class="lesProducts menu-item menu-item-type-custom menu-item-object-custom">
            <label for="prod_filter-marche">
              <?php $filtersArray = (isset($_GET['filters'])) ? explode(',', $_GET['filters']) : array(); ?>
              <input type="checkbox" class='prod_filter' name="prod_filter-marche" value="marche-atwater" <?= (in_array('marche-atwater', $filtersArray)) ? 'checked' : '' ?>>
              <span class="customcheckbox"></span> <span class="checkedlabel">Marché Atwater</span> 
            </label>
            <br>
          </li>
